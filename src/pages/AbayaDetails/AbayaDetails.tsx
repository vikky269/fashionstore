...
const AbayaDetails = () => {
   const { productId } = useParams();
     const product = abayas.find((product) => product.id === Number(productId)) as ProductDetailsProps;
     ...
     const handleBuyNow = (product: ProductDetailsProps) => {
       ...
       const whatsappUrl = `https://wa.me/2347013730532?text=${encodeURIComponent(message)}`;
